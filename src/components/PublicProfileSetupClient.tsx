        ...
        <div className="flex items-start gap-3 rounded-2xl border border-blue-200 bg-blue-50 p-4">
          ...
          <div>
            ...
            <p className="mt-0.5 text-xs text-blue-700">
              Copy your profile link and post it on LinkedIn with: &ldquo;Excited to share my verified career profile and certifications!&rdquo; This gets you visibility and markets ZENVY for free.
            </p>
          </div>
        </div>
      )}
